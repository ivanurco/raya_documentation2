...
Execute multiple predefined poses for an arm in a row.
...
predefined_poses           ``list``                       List of predefined poses.                               
...
See the `Arms Execute Predefined Pose Array <https://github.com/Unlimited-Robotics/pyraya_examples/tree/main/arms_execute_predefined_pose_array>`__ to see how to use this function.
