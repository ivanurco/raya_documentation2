...
.. raw:: html
    ...
    <div class="warning-box">
        ...
        If the original map Check the “Gary
        Options” section for an example of options that are valid for Gary.
        </p>
    </div>
...
|                  |            | mapping process.                   |
+------------------+------------+------------------------------------+
| marker_length    | ``float``  | Apriltags size (all tags must be   |
|                  |            | the same size).                    |
+------------------+------------+------------------------------------+
...
See the `map_continue <https://github.com/Unlimited-Robotics/pyraya_examples/tree/main/map_continue>`__ to check
some valid uses.
